      ...
      >
        ...
        <div className="flex gap-3">
          <Button
            variant="outline"
            onClick={() => close(false)}
            className="flex-1 gap-2 border-border hover:bg-secondary hover:text-secondary-foreground cursor-pointer"
          >
          ...
          <Button
            variant="destructive"
            onClick={() => del()}
            className="flex-1 gap-2 bg-destructive text-destructive-foreground hover:bg-destructive/90 cursor-pointer"
          >
